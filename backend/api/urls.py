...
urlpatterns = [
    ...
    path('anonymous-tips/', views.AnonymousTipView.as_view(), name='anonymous-tips'),
    path('officer/anonymous-tips/', views.OfficerAnonymousTipView.as_view(), name='officer-anonymous-tips'),
    path('officer/anonymous-tips/<int:tip_id>/', views.OfficerAnonymousTipView.as_view(), name='officer-anonymous-tips-detail'),
